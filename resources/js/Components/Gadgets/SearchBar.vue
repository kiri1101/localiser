<template>
  <form>
    <div class="flex rounded-lg ring-8 ring-white/50">
      <label
        for="search-dropdown"
      ...
      <div
        v-show="showMenu"
        id="dropdown"
        class="z-10 absolute translate-y-12 transition-all duration-500 ease-in-out bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700"
      >
        <ul
